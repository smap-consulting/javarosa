...
public class GeoCompoundData implements IAnswerData, IExprDataType {
    ...
    public GeoCompoundData(GeoTrace atrace) {
    ...
    public void setValue(Object o) {
        ...
        if ( !(o instanceof GeoTrace) ) {
            GeoCompoundData t = new GeoCompoundData();
            GeoCompoundData v = t.cast(new UncastData(o.toString()));
            o = v.getValue();
        }
    ...
    public GeoCompoundData cast(UncastData data) throws IllegalArgumentException {
        ...
        GeoCompoundData d = new GeoCompoundData();
